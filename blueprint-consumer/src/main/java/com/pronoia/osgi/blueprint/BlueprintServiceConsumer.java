...
public class BlueprintServiceConsumer {
    ...
    class BlueprintConsumerTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            injectedService.execute( "Calling injected service {" + injectedService.getClass().getName() + " " + injectedService.hashCode() +"} from blueprint");
            if (null != discoveredService) {
                ...
                discoveredService.execute("Calling discovered service {" + discoveredService.getClass().getName() + " " + discoveredService.hashCode() + "} from blueprint");
            }
        }
    }
